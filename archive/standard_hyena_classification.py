...
def run_metabolic_training():
    # Initialize WandB
    wandb.init(
        project="hyena-dna-metabolic-standard-classification",  # Change this to your project name
    ...
    # Model settings
    pretrained_model_name = 'hyenadna-tiny-32k-seqlen'
    use_head = True
    n_classes = 4
    ...
    dataset = MetabolicDataset(df=df, max_length=max_length, tokenizer=tokenizer, use_padding=use_padding, rc_aug=rc_aug, add_eos=add_eos)
    ...
    # Compute class weights and setup loss
    ...
    # Finish WandB Run
    torch.save(model.state_dict(), "hyena_dna_metabolic.pth")
    wandb.save("hyena_dna_metabolic.pth")
    wandb.finish()

...
#SBATCH -t 48:00:00                    # Adjust time as needed
...
srun --mpi=pmi2 python3 -m train \
   wandb.project=hyena-dna-multispecies-64k-rerun \
...
# 4. there is no early stopping in this case but there is weight checkpointing
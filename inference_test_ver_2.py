...
class GenomicBenchmarkDataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        dest_path="/u/pmaldonadocatala/benchmarks_hyena-dna/data", # default for colab
        tokenizer=None,
        tokenizer_name=None,
        use_padding=None,
        add_eos=False,
...
def run_train():
    ...
    log_file = f"training_log_{dataset_name}.json"
    ...
    if pretrained_model_name in ['hyenadna-tiny-1k-seqlen']:
        model = HyenaDNAPreTrainedModel.from_pretrained(
            '/u/pmaldonadocatala/benchmarks_hyena_dna/checkpoints/',
    ...
    log_results(log_file, {"dataset": dataset_name, "num_train_samples": len(ds_train), "num_test_samples": len(ds_test)})
    ...
    print(f"Best accuracy: {best_metrics['accuracy']:.2f}% at loss {best_metrics['loss']:.4f}")

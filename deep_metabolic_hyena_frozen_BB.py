...
def run_metabolic_training():
    ...
    # Freeze the entire backbone so that its weights are not updated during training
    for param in backbone.parameters():
        param.requires_grad = False

    # Wrap backbone with deeper classifier (the classifier head remains trainable)

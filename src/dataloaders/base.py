...
# Define the Multispecies dataset
class MultispeciesDataset(SequenceDataset):
    _name_ = 'multispecies'

    def init(self):
        # Initialize your dataset here, load data files, etc.
        pass

    def setup(self):
        # Set up the train, val, and test datasets
        # self.dataset_train, self.dataset_val, self.dataset_test should be defined here
        pass

# Register MultispeciesDataset to the SequenceDataset registry
SequenceDataset.registry['multispecies'] = MultispeciesDataset

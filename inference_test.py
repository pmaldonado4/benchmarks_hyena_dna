...
class GenomicBenchmarkDataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        dest_path="/u/pmaldonadocatala/hyena-dna/data", # default for colab
        tokenizer=None,
        tokenizer_name=None,
        use_padding=None,
        add_eos=False,
...
def run_train():
    ...
    max_length = 200  # max len of sequence of dataset (of what you want)
    use_padding = True
    dataset_name = 'human_enhancers_cohn'
    batch_size = 256
    ...
    if pretrained_model_name in ['hyenadna-tiny-1k-seqlen']:
        ...
        model = HyenaDNAPreTrainedModel.from_pretrained(
            '/u/pmaldonadocatala/hyena-dna/checkpoints/',
